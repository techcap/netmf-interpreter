...
/**
  ...
  *            @arg GPIO_AF_SAI1: Connect SAI1 pins to AF6 for STM32F429X device        
  ...
  *            @arg GPIO_AF_FMC: Connect FMC pins to AF12 for STM32F429X device   
  *            @arg GPIO_AF_OTG_HS_FS: Connect OTG HS (configured in FS) pins to AF12
  *            @arg GPIO_AF_SDIO: Connect SDIO pins to AF12
  *            @arg GPIO_AF_DCMI: Connect DCMI pins to AF13
  *            @arg GPIO_AF_LTDC: Connect LTDC pins to AF14 for STM32F429X device  
