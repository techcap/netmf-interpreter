...
//based on https://developer.mbed.org/forum/bugs-suggestions/topic/5600/
 ...
 ===================================================================================  
    [..]
      ...
      (#) PLLSAI clocked by (HSI or HSE), used to generate an accurate clock to SAI 
          interface and LCD TFT controller available only for STM32F429x/439x devices.
...
/**
  ...
  * @note   You have to set the PLLI2SR parameter correctly to not exceed 192 MHz
  *         on the I2S clock frequency.
  * @note   the PLLI2SR parameter is only available with STM32F429x/439x Devices. 
  *   
  * @retval None
  */
...
/**
  ...
  *            @arg RCC_AHB1Periph_GPIOJ:       GPIOJ clock (STM32F429x/439x devices) 
  *            @arg RCC_AHB1Periph_GPIOK:       GPIOK clock (STM32F429x/439x devices)  
  *            @arg RCC_AHB1Periph_CRC:         CRC clock
  *            @arg RCC_AHB1Periph_BKPSRAM:     BKPSRAM interface clock
  *            @arg RCC_AHB1Periph_CCMDATARAMEN CCM data RAM interface clock
  *            @arg RCC_AHB1Periph_DMA1:        DMA1 clock
  *            @arg RCC_AHB1Periph_DMA2:        DMA2 clock
  *            @arg RCC_AHB1Periph_DMA2D:       DMA2D clock (STM32F429x/439x devices)  
...
/**
  ...
  *            @arg RCC_APB2Periph_SAI1:   SAI1 clock (STM32F429x/439x devices) 
  *            @arg RCC_APB2Periph_LTDC:   LTDC clock (STM32F429x/439x devices) 
  * @param  NewState: new state of the specified peripheral clock.
  *          This parameter can be: ENABLE or DISABLE.
  * @retval None
  */
...
/**
  ...
  *            @arg RCC_IT_PLLSAIRDY: PLLSAI ready interrupt (only for STM32F429x/439x devices)
...
/**
  ...
  *            @arg RCC_FLAG_PLLSAIRDY: PLLSAI clock ready (only for STM32F429x/439x devices)
...
/**
  ...
  *            @arg RCC_IT_PLLRDY: main PLL ready interrupt
  *            @arg RCC_IT_PLLI2SRDY: PLLI2S ready interrupt           
  *            @arg RCC_IT_PLLSAIRDY: PLLSAI clock ready interrupt (only for STM32F429x/439x devices)    
