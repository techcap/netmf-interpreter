...
#define FLASH_BLOCK_COUNT6                   14
#define FLASH_BYTES_PER_BLOCK6               0x10000
...
#define STM32F4__SIZE_IN_BYTES     0x00200000 
...
{
	{ BlockRange::BLOCKTYPE_CODE      ,   0, 5 },  // 08020000 CLR         640k
	{ BlockRange::BLOCKTYPE_DEPLOYMENT,   6, 6 },  // 08080000 deployment  256k
};
...
{
    { BlockRange::BLOCKTYPE_DEPLOYMENT,   0, 0 },  // 08080000 deployment  64k
};

const BlockRange g_STM32F4_BlockRange6[] =
{
    //{ BlockRange::BLOCKTYPE_DEPLOYMENT,   0, 6 },  // 08080000 deployment  896k
	{ BlockRange::BLOCKTYPE_STORAGE_A, 0, 3 },  
	{ BlockRange::BLOCKTYPE_STORAGE_B, 4, 7 },
	{ BlockRange::BLOCKTYPE_UPDATE, 8, 13 },  
};
