...
//string descriptor
#define     MANUFACTURER_NAME_SIZE 24   // "Sudo Premium Engineering"
...
#define     PRODUCT_NAME_SIZE      15   // "SmartController"
// NOTE: If these two strings are not present, the MFUSB KERNEL driver will *CRASH*
// which, of course, causes Windows to crash
#define     DISPLAY_NAME_SIZE      15   // "SmartController"
#define     FRIENDLY_NAME_SIZE      15   // "SmartController"
...
const struct USB_DYNAMIC_CONFIGURATION UsbDefaultConfiguration =
{
	...
	{ 'S', 'u', 'd', 'o', ' ', 'P', 'r', 'e', 'm', 'i', 'u', 'm', ' ', 'E', 'n', 'g', 'i', 'n', 'e', 'e', 'r', 'i', 'n', 'g'},
